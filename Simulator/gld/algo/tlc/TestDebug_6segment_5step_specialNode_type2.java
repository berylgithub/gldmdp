 ...
 * @version 1.0
 */
public class TestDebug_6segment_5step_specialNode_type2 extends TLController {

    public static final String shortXMLName = "TestDebug-6-segment-5-step-specialnode-type2";
    int actionCounter;
    Infrastructure infrastructure;
    ArrayList<TuppleStateActionConainer> arrTSAC = new ArrayList<>();
    ArrayList<TuppleStateActionConainer>[] arrMultiTSAC;

    public TestDebug_6segment_5step_specialNode_type2(Infrastructure infras) {
        super(infras);
...
//                    }
                    ...
                    Logger.getLogger(TestDebug_6segment_5step_specialNode_type2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public TLDecision[][] decideTLs() {
        ...
        if (currentCycle % 10000 == 0) {
            for (int h = 0; h < arrMultiTSAC.length; h++) {
                if (h == 6 || h == 7) {
                    try {
                        PrintWriter testPrint = new PrintWriter("State-Action Debug_6-segment_5-step_random_specialnode_type2-" + h + "_train.txt");
...
//                            System.out.print(arrMultiTSAC[h].get(i).arrState.get(j));
    ...
    public String getXMLName() {
        return "testdebug-6-segment-5-step-specialnode-type2";
    }
}
