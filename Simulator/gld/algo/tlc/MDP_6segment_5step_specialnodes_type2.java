 ...
 * @version 1.0
 */
public class MDP_6segment_5step_specialnodes_type2 extends TLController {

    public static final String shortXMLName = "MDP_6segment_5step_specialnodes_type2";
...
//    ArrayList<ActionSeqContainer> arrASC=new ArrayList<>();
     ...
     */
    public MDP_6segment_5step_specialnodes_type2(Infrastructure infras) throws IOException {
        super(infras);
        ...
        for (int i = 0; i < arrMultiSBAC.length; i++) {
            if (i == 6 || i == 7) {
                arrMultiSBAC[i] = loadActionFile("Value Iteration Result_6-segment_5-step_random_specialnode_type2-" + i + "_train.txt");
            }
        ...
        for (int i = 0; i < tld.length; i++) {
            ...
            for (int j = 0; j < tld[i].length; j++) {
                try {
                    ...
                    Logger.getLogger(MDP_6segment_5step_specialnodes_type2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
        for (int i = 0; i < tld.length; i++) {
...
//            }
    ...
    public String getXMLName() {
        return "MDP_6segment_5step_specialnodes";
    }
}
