 ...
 * @version 1.0
 */
public class TestDebug_3segment_5step_specialNode_type2 extends TLController {

    public static final String shortXMLName = "TestDebug-3-segment-5-step-specialnode-type2";
    int actionCounter;
    Infrastructure infrastructure;
    ArrayList<TuppleStateActionConainer> arrTSAC=new ArrayList<>();
    ArrayList<TuppleStateActionConainer>[] arrMultiTSAC;

    public TestDebug_3segment_5step_specialNode_type2(Infrastructure infras) {
        super(infras);
...
//                    }
                    ...
                    Logger.getLogger(TestDebug_3segment_5step_specialNode_type2.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    ...
    public String getXMLName() {
        return "testdebug-3-segment-5-step-specialnode-type2";
    }
}
