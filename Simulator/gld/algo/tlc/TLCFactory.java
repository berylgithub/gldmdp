...
public class TLCFactory {
    ...
    protected static final int RANDOM = 0,
            ...
            MDP6SEGMENT5STEPSPECIALNODESTYPE2 = 53;
    ...
    protected static final String[] tlcDescs = {
        ...
        "MDP 6 segment 5 step Special Nodes type 2",};
    ...
    protected static final String[] xmlNames = {
        ...
        MDP_6segment_5step_specialnodes_type2.shortXMLName,};
    ...
    public TLController getInstanceForLoad(int algoId) throws InfraException {
        switch (algoId) {
            ...
            //
            case FIXEDCYCLE:
                return new FixedCycle(infra);
            case PERCENTAGE:
                return new PercentageQue(infra);
            case TESTDEBUG:
                return new TestDebug(infra);
            case TESTDEBUG2SEGMENT:
                return new TestDebug_2segment(infra);
            ...
            case TESTDEBUGNSEGMENT:
                return new TestDebug_nsegment(infra);
            case TESTDEBUG2SEGMENT5STEP:
                return new TestDebug_2segment_5step(infra);
            ...
            case TESTDEBUG2SEGMENT5STEPMULTINODES:
                return new TestDebug_2segment_5step_multinodes(infra);
            case MDP2SEGMENT5STEPMULTINODES: {
                try {
                    return new MDP_2segment_5step_multinodes(infra);
                } catch (IOException ex) {
                    Logger.getLogger(TLCFactory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            case TESTDEBUG3SEGMENT5STEP:
                return new TestDebug_3segment_5step(infra);
            case MDP3SEGMENT5STEP: {
                try {
                    return new MDP_3segment_5step(infra);
                } catch (IOException ex) {
                    Logger.getLogger(TLCFactory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            case TESTDEBUG3SEGMENT5STEPNEIGHBOORSTATES:
                return new TestDebug_3segment_5step_neighboorStates(infra);
            ...
            case TESTDEBUG3SEGMENT5STEPSPECIALNODES:
                return new TestDebug_3segment_5step_specialNode(infra);
            case MDP3SEGMENT5STEPSPECIALNODES: {
                try {
                    return new MDP_3segment_5step_specialnodes(infra);
                } catch (IOException ex) {
                    Logger.getLogger(TLCFactory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            case TESTDEBUG3SEGMENT5STEPSPECIALNODESTYPE2:
                return new TestDebug_3segment_5step_specialNode_type2(infra);
            ...
            case TESTDEBUG5SEGMENT5STEPSPECIALNODESTYPE2:
                return new TestDebug_5segment_5step_specialNode_type2(infra);
            case MDP5SEGMENT5STEPSPECIALNODESTYPE2: {
                try {
                    return new MDP_5segment_5step_specialnodes_type2(infra);
                } catch (IOException ex) {
                    Logger.getLogger(TLCFactory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            ...
            case MDP6SEGMENT5STEPSPECIALNODESTYPE2: {
                try {
                    return new MDP_6segment_5step_specialnodes_type2(infra);
                } catch (IOException ex) {
                    Logger.getLogger(TLCFactory.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
