 ...
 * @version 1.0
 */
public class TestDebug_2segment_5step_multinodes extends TLController {

    public static final String shortXMLName = "TestDebug-2-segment-5-step-multinodes";
    int actionCounter;
...
//    ArrayList<ActionSeqContainer> arrASC=new ArrayList<>();
    ...
    public TestDebug_2segment_5step_multinodes(Infrastructure infras) {
        super(infras);
        actionCounter=0;
    ...
    public TLDecision[][] decideTLs() {
        ...
        try {
            ...
            Logger.getLogger(TestDebug_2segment_5step_multinodes.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public String getXMLName() {
        return "testdebug-2-segment-5-step-multinodes";
    }
}
