...
public class TrackerFactory
{
	...
	*/
	...
	{
		Enumeration enumm = trackingControllers.elements();
		while(enumm.hasMoreElements())
			((TrackingController)enumm.nextElement()).closeWindow();
	}
	...
	public static void disableTrackerViews()
	{
		Enumeration enumm = trackingControllers.elements();
		while(enumm.hasMoreElements())
			((TrackingController)enumm.nextElement()).setViewEnabled(false);
	}
	...
	public static void resetTrackers()
	{
		Enumeration enumm = trackingControllers.elements();
		while(enumm.hasMoreElements())
			((TrackingController)enumm.nextElement()).reset();
	}
	...
	public static TrackingController[] getTrackingControllers()
	{
		...
		int i=0;
		while(enumm.hasMoreElements()) {
			tca[i] = ((TrackingController)enumm.nextElement());
			i++;
		}
		return tca;	
	}
